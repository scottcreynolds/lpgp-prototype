...
- Note trade-offs when intent is not obvious.
...
- Output debug messages to console or logs as appropriate.
...
- Follow established patterns for commands, queries, and event handling.
- Adhere to Separation of Concerns; avoid mixing business logic with infrastructure code.
- Use design patterns (Factory, Singleton, Strategy, Observer) appropriately to enhance code maintainability and readability.
